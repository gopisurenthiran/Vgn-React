// Header.jsx  – React + Bootstrap 5  (Mulish 12 px font)
// ------------------------------------------------------
// • Logo left, menu right
// • Hover-open dropdowns ≥ lg
// • Drawer closes after any route change
// • Active page = red underline (parent) + red left bar (dropdown item)
