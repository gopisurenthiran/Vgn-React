...
Another vital document required while processing an NRI home loan is the power of attorney (POA). The POA is important because, since the borrower is not based in India; the Home Finance Company would need a 'representative' 'in lieu of' the NRI to deal with and if needed. Although not obligatory, the POA is usually drawn on the NRI's parents/wife/children/ close relatives or friends.
        ...
        <br/>
        <FaAngleDoubleRight />Passport and Visa
        <br />
        <FaAngleDoubleRight /> A copy of the appointment letter and contract from the company employing the applicant.
        <br />
        <FaAngleDoubleRight /> The labour card/identity card (translated in English and countersigned by the consulate) if the person is employed in the Middle East Salary certificate (in English) specifying name, date of joining, designation and salary details.
        <br />
        ...
        <br/>
        <FaAngleDoubleRight /> Copy of valid visa / work permit / equivalent document supporting the NRI status of the proposed account holder
        <br/>
        <FaAngleDoubleRight /> Overseas Bank A/C for the last 3 months showing salary credits
        <br/>
        <FaAngleDoubleRight /> Latest contract copy evidencing Salary / Salary Certificate / Wage Slips
        <br/>
        <br/>
         <b>Self-Employed NRI Applicants</b>
         <br/>
        <FaAngleDoubleRight />Passport copy with valid visa stamp
        <br/>
        <FaAngleDoubleRight /> Brief profile of the applicant and business/ Trade license or equivalent document
        <br/>
        <FaAngleDoubleRight />6 months overseas bank account statement and NRE/ NRO account
        <br/>
        <FaAngleDoubleRight />Computation of income, P&L account and B/Sheet for last 3 years certified by the C.A. / CPA or any other relevant authority as the case may be (or equivalent company accounts)
        <br/>
      </>,
  },
  {
    question: "What is the Tax treatment for income generated from property selling or renting for NRI/PIO/OCI?",
  ...
  {
    question: "How does Double Taxation Avoidance Agreement work in case of NRIs?",
