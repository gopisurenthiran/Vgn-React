...
const faqData = [
  {
    ...
    answer: `An Indian citizen who stays abroad for employment/carrying on business or vocation outside India...`,
  },
  {
  ...
  },
  {
    ...
    answer: `There is no restriction on the number of residential or commercial properties...`,
  },
  {
    question: "Can NRIs acquire commercial properties in India?",
    answer: `Yes, under the general permission granted by the Reserve Bank...`,
  },
  {
    question:
      "Can NRIs buy properties in India without the Reserve Bank’s permission?",
    answer: `Reserve Bank has granted general permission to foreign citizens of Indian origin...`,
  },
  {
    question:
    ...
    answer: `They are required to file a declaration in form IPI 7...`,
  },
  {
  ...
  },
  {
    question:
      "Who is a PIO?",
    answer: `A person of Indian origin means an individual (not being a citizen of Pakistan or Bangladesh or Sri Lanka or Afghanistan or China or Iran or Nepal or Bhutan) who:
 ...
 who or whose father or paternal grandfather was a citizen of India by virtue of the Constitution of India or the Citizenship Act, 1955`,
  ...
  {
    question: "Is there any restriction on the number of properties NRIs can buy in India?",
  ...
  {
    question: "Can NRIs buy properties in India without the Reserve Bank’s permission?",
  ...
  },
  {
  ...
  },
   {
    ...
    answer: `The following is the list (non-exhaustive) of documents required for NRIs to buy property in India:
 ...
 Address proof`,
  },
   {
    ...
    answer: `The documentation required to be submitted by the NRIs are different from the Resident Indians as they are required to submit additional documents, like copy of the passport and a copy of the works contract, etc. and of course NRIs have to follow certain eligibility criteria in order to get Home Loans in India.
