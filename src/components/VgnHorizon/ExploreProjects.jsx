...
const NextArrow = ({ onClick }) => (
  <button className="custom-slick-arrow3 next-arrow" onClick={onClick} aria-label="Next">
    <i className="fa fa-angle-right"></i>
  </button>
);

const PrevArrow = ({ onClick }) => (
  <button className="custom-slick-arrow3 prev-arrow" onClick={onClick} aria-label="Previous">
  ...
  return (
    <section className="property-details-section py-5" id="expore-projects" style={{ background: "#f9f9f9" }}>
      <div className="container">
        <div className="section-title3 mb-4">
          <h4>
