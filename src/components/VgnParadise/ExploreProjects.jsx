...
const NextArrow = ({ onClick }) => (
  <button className="custom-slick-arrow2 next-arrow" onClick={onClick} aria-label="Next">
    <i className="fa fa-angle-right"></i>
  </button>
);

const PrevArrow = ({ onClick }) => (
  <button className="custom-slick-arrow2 prev-arrow" onClick={onClick} aria-label="Previous">
