...
import bank1 from '@/assets/vgn-varnabhoomi/bank1.png';
import bank2 from '@/assets/vgn-varnabhoomi/bank2.png';
import bank8 from '@/assets/vgn-varnabhoomi/bank8.png';
import bank9 from '@/assets/vgn-varnabhoomi/bank9.png';
...
const NextArrow = ({ onClick }) => (
  <button className="custom-slick-arrow11 next-arrow" onClick={onClick} aria-label="Next">
    <i className="fa fa-angle-right"></i>
  </button>
);

const PrevArrow = ({ onClick }) => (
  <button className="custom-slick-arrow11 prev-arrow" onClick={onClick} aria-label="Previous">
...
export default function ExploreProjects() {
    ...
    { src: bank8, alt: 'Bank 8' },
    { src: bank9, alt: 'Bank 9' },
  ];
  const projects = [
    {
  ...
  return (
    <>
    <section className="property-details-section" style={{ background: '#f9f9f9' }}>
      <div className="container">
        <div className="section-title11">
          <h4 style={{ marginBottom: '35px' }}>Loans approved by</h4>
        </div>
        <div className="row">
          {banks.map((bank, index) => (
            <div key={index} className="col-lg-3 col-md-3 col-sm-6 col-xs-12 col2 text-center mb-4">
              <img src={bank.src} alt={bank.alt} width="180px" />
            </div>
          ))}
        </div>
      </div>
    ...
    <section className="property-details-section py-5" id="expore-projects" style={{ background: "#f9f9f9" }}>
      <div className="container">
        <div className="section-title11 mb-4">
          <h4>
